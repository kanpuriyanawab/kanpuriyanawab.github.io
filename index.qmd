...
<p style="text-align: center;">
  <a href="https://fullstackagents.substack.com/subscribe" 
     target="_blank" 
     style="display: inline-block; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; background-color: #FF6719; color: #FFFFFF; font-size: 16px; font-weight: 600; padding: 12px 24px; border-radius: 8px; text-decoration: none;">
